...
function slidein() {
    ...
    navButton.style.backgroundImage = "url(/assets/img/slide-nav-icons/nav-button-reverse.svg)";
    onpage = true;
}
...
function slideout() {
    ...
    navButton.style.backgroundImage = "url(/assets/img/slide-nav-icons/nav-button.svg)";
    onpage = false;
}
